...
public class ELIMINARGESTIONUSUARIOS extends javax.swing.JFrame {
    ...
    public ELIMINARGESTIONUSUARIOS() {
        initComponents();
        indiceActual = 0;
    ...
    private void initComponents() {
        ...
        btnEliminarUsuarioSistema = new javax.swing.JButton();
        ...
        jTextField5.setText(" ELIMINAR USUARIO DEL SISTEMA");
        ...
        btnEliminarUsuarioSistema.setBackground(new java.awt.Color(0, 102, 255));
        btnEliminarUsuarioSistema.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        btnEliminarUsuarioSistema.setForeground(new java.awt.Color(255, 255, 255));
        btnEliminarUsuarioSistema.setText("ELIMINAR");
        btnEliminarUsuarioSistema.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 51, 51), 3));
        btnEliminarUsuarioSistema.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEliminarUsuarioSistemaActionPerformed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                        ...
                        .addComponent(btnEliminarUsuarioSistema, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtNombreUsuarioBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 505, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btnBuscarUsuarioSistema, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGap(37, 37, 37)
                .addComponent(btnEliminarUsuarioSistema, javax.swing.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
                .addGap(17, 17, 17))
        );
    ...
    private void btnEliminarUsuarioSistemaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarUsuarioSistemaActionPerformed
     int filaSeleccionada = tblRegistroUsuarios.getSelectedRow();

    
        if (filaSeleccionada >= 0) {
       
            long dpiSeleccionado = (long) tblRegistroUsuarios.getValueAt(filaSeleccionada, 6);
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                for (Usuarios usuario : listaUsuarios) {
                    if (usuario.getNumeroDPI() == dpiSeleccionado) {
    ...
    }//GEN-LAST:event_btnEliminarUsuarioSistemaActionPerformed
...
if (txtNombreUsuarioBuscar.getText().trim().isEmpty() ||
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ELIMINARGESTIONUSUARIOS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ELIMINARGESTIONUSUARIOS().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btnEliminarUsuarioSistema;
